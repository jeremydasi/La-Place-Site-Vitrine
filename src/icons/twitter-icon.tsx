...
const TwitterIcon: React.FunctionComponent<PropsIcon> = ({ color, height, width }) => {
    return (
        <svg width={width} height={height} viewBox="0 0 21 20" fill={color} xmlns="http://www.w3.org/2000/svg">
            <g clipPath="url(#clip0_997_20504)">
                <path
            ...
            <defs>
                <clipPath id="clip0_997_20504">
                    <rect width="20" height="20" fill="white" transform="translate(0.973877)" />
                </clipPath>
            </defs>
        </svg>
    );
